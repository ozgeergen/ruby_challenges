...
def numerology (birthpath_number)
...
puts "What is your birthday? Please submit in the format of MMDDYYYY"
birthdate = gets.to_s
    
birthpath_number = birthpath_number(birthdate) 
    
message = numerology (birthpath_number)
